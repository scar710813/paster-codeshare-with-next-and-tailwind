  ...
  return (
    <div className='w-full flex justify-between'>
         <div className="flex items-center text-white ">
          ...
          <Link href="/auth" className="flex"><Image width={20} height={20} src="/dummy-profile.jpeg" className="mx-2 rounded-md h-[20px]"/> Sign in 
          <Image width={12} height={12} alt='updownarrow' src="/updownarrow.svg"/> </Link>
        </div>
